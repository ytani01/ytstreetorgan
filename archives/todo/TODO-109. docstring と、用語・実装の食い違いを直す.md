# TODO-109. docstring と、用語・実装の食い違いを直す

> 元は TODO-092。別のマシンで同じ番号を別の項目に使っていたため、マージのときに
...
- 対象箇所の下調べは TODO-108 の待ち時間に済ませたので、そのぶんは
  TODO-108 側の数字に入っている

分担の理由と報告は `archives/agents/TODO-109/` にある。

## きっかけ

TODO-106 で `docs/User.md` を書いたときに見つけた 2 件。どちらも
