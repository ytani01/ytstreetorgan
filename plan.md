...
関連: [[plan.md]] (ロギング移行), [[MODERNIZATION_PLAN.md]] (Web層の全面刷新・保留中)
...
- ❌ 対象外: Tornado → FastAPI 移行、フロントエンド刷新（[[MODERNIZATION_PLAN.md]] 側で「まだ実施しない」とされているため、本計画では触らない）
...
[[MODERNIZATION_PLAN.md]] で計画されている Tornado → FastAPI 移行を見据え、
